...
drop view if exists view_msrDeathSummary;

create view view_msrDeathSummary as

select
      s1.chwID,
      s1.yearReported,
      s1.monthReported,
      s1.routineVisitsPopulationStillBirthsTotal,
      s1.routineVisitsPopulationNeonatalDeathsTotal,
      s1.routineVisitsPopulationPostNeonatalDeathsTotal,
      s1.routineVisitsPopulationChildDeathsTotal,
      s1.routineVisitsPopulationMaternalDeathsTotal,
      s1.routineVisitsPopulationAdultDeathsTotal,
      l.staffName,
      l.community,
      l.district,
      l.healthDistrict,

...
drop view if exists lastmile_ncha.view_geo_community_cha_population;

create view lastmile_ncha.view_geo_community_cha_population as 
...
from lastmile_ncha.view_geo_community as c
    left outer join lastmile_ncha.view_community_registration as g on c.community_id = g.community_id
    left outer join lastmile_ncha.view_community_cha          as a on c.community_id = a.community_id
;
...
-- drop view if exists lastmile_ncha.view_position_cha_supervisor;
-- create view lastmile_ncha.view_position_cha_supervisor as
...
from lastmile_ncha.view_position_cha as p
    left outer join lastmile_ncha.position_supervisor as ps on ( p. position_id_pk = ps.position_id_pk ) and ( ps.end_date is null )
        left outer join lastmile_ncha.view_position_chss as s on ps.position_supervisor_id_pk = s.position_id_pk
;
...
drop view if exists lastmile_ncha.view_position_qao_person;

create view lastmile_ncha.view_position_qao_person as
...
from lastmile_ncha.view_position_qao as p

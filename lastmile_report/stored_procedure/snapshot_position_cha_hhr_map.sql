...
drop procedure if exists snapshot_position_cha_hhr_map;

/* 
 * Note:  This procedure used to be snapshot_position_cha, but the HHR and mapping #households have not reached 
 *        the point where we have enough confidence in it to base our population calculations on it.
 *
...
create procedure snapshot_position_cha_hhr_map( in snapshot_date date, in position_status varchar(255) )
begin
...
drop temporary table if exists faux_cursor_snapshot_position_cha_hhr_map;

create temporary table faux_cursor_snapshot_position_cha_hhr_map as
...
-- select * from faux_cursor_snapshot_position_cha_hhr_map;

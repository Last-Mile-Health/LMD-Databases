...
drop view if exists lastmile_report.view_base_msr_chss;

create view lastmile_report.view_base_msr_chss as

select 
        chss_name       as chss_name,
        chss_id         as chss_id,
        county          as county,
        county_id       as county_id,
        month_reported  as month_reported,
        year_reported   as year_reported,
    ...
    group by chss_id , month_reported , year_reported
...
drop view if exists lastmile_report.view_diagnostic_de_id_invalid_original_total_table_type;

create view lastmile_report.view_diagnostic_de_id_invalid_original_total_table_type as

...
drop view if exists lastmile_report.view_diagnostic_odk_id_invalid_repair_total_table_type;

create view lastmile_report.view_diagnostic_odk_id_invalid_repair_total_table_type as
